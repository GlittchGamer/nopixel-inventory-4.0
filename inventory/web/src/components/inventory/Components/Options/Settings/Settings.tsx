    ...
    return (
        ...
        >
            <div class="absolute inset-0 z-50 flex items-center justify-center">
                <div class="flex h-1/5 w-1/2 flex-col overflow-hidden rounded bg-neutral-800">

                    <div class="flex h-1/3 w-full flex-col items-center justify-center">
                        <div class="flex h-1/2 w-full items-center justify-center">
                            <span class="text-xl text-neutral-400">
                                Hold to drag
                            </span>
